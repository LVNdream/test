...
/////////////////////////////////////////////////////////////////
//ấn sub thì chuyển qua trang kế bên vào có tài liệu ỏe trang kế bên bằng LocalStore
//console.log(window.location);
//if(location.pathname ==='/vidu2lc.html'){
    //console.log("page 1")
    ...
    form1.addEventListener('submit', function (e){
        ...
        const ho = document.getElementById("firstname");
        const ten = document.getElementById("lastname");
        ...
        if(JSON.parse(localStorage.getItem('cartInfor'))===null){
            arrayInfor.push(infor);
            localStorage.setItem("cartInfor",JSON.stringify(arrayInfor));
            //window.location.reload(); // load trang
        }
        // Storage da co
        else{
            arrayInfor=JSON.parse(localStorage.getItem('cartInfor'));
            //sản phẩm thêm vào đã có trong cart
            arrayInfor.push(infor);
            window.localStorage.setItem('cartInfor',JSON.stringify(arrayInfor));
       ...
       while (url[i] !== '/')  {
        ...
        //
        //////Nhay qua trang khac khi nhan submit
        url =url.slice(0,i) + `/vidu22lc.html`;
